...
public class URL implements Serializable {
    ...
    public String getAddressListStr() {
        return String.join(",", getAddresses());
    }
    ...
    public Object toObject(Class<?> beanClass) {
        Object obj;
        try {
    ...
    public Object toObject(Object obj) {
        ...
        try {
            ...
            for (Field field : fields) {
                Object val = parameters.get(field.getName());
                if (val == null) {
                    continue;
                }
                ...
                field.set(obj, cast(val, field.getType()));
            }
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    ...
    public Map<String, Object> addParameters(Object obj) {
        if (obj == null) {
            return null;
        }
        ...
        try {
            for (Field field : declaredFields) {
                ...
                field.setAccessible(true);
                parameters.put(field.getName(), String.valueOf(val));
            }
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    ...
    private static Object cast(final Object value, final Class<?> clz) {
        ...
        if (obj == null) {
            ...
            return BigInteger.valueOf(Long.valueOf(obj));
